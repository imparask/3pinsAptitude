...
<input type="hidden" name="page" value="q20">
A alone can do a piece of work in 6 days and B alone in 8 days.A and B undertook to do it for Rs. 3200.<br>
With the help of C, they completed the work in 3 days. How much is to be paid to C?<br><br>
<input type="radio" name="A" value="1">Rs. 375<br>
<input type="radio" name="B" value="1">Rs. 400<br>
<input type="radio" name="C" value="1">Rs. 600<br>
<input type="radio" name="D" value="1">Rs. 800<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q18"><button>BACK</button></a><br><br>
</body>
</html>