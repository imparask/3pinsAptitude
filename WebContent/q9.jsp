...
The Parliament of India can make use of the residuary powers<br><br>
<input type="radio" name="A" value="1">At All Times<br>
<input type="radio" name="B" value="1">Only During National Emergency<br>
<input type="radio" name="C" value="1">During National Emergency As Well As Constitutional Emergency As Well In A State<br>
<input type="radio" name="D" value="1">Non Of The Above<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q8"><button>BACK</button></a><br><br>
</body>
</html>