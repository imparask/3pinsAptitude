...
<input type="hidden" name="page" value="q15">
Chloroplast is found in<br><br>
<input type="radio" name="A" value="1">Plant Cell Only<br>
<input type="radio" name="B" value="1">Animal Cell Only<br>
<input type="radio" name="C" value="1">Both Of These<br>
<input type="radio" name="D" value="1">Non Of These<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q13"><button>BACK</button></a><br><br>
</body>
</html>