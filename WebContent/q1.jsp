...
<input type="hidden" name="page" value="q2">
The price of commodity X increases by 40 paise every year, while the price of commodity Y increases by 15 paise every year.<br> If in 2001,
the price of commodity X was Rs. 4.20 and that of Y was Rs. 6.30, in which year commodity X will cost 40 paise more than the commodity Y ?<br><br>
<input type="radio" name="A" value="1">2010<br>
<input type="radio" name="B" value="1">2011<br>
<input type="radio" name="C" value="1">2012<br>
<input type="radio" name="D" value="1">2013<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=AT"><button>BACK</button></a><br><br>
</body>
</html>