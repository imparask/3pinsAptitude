...
<input type="hidden" name="page" value="q18">
Hen's egg is a<br><br>
<input type="radio" name="A" value="1">Tissue<br>
<input type="radio" name="B" value="1">Organ<br>
<input type="radio" name="C" value="1">Organ System<br>
<input type="radio" name="D" value="1">Cell<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q16"><button>BACK</button></a><br><br>
</body>
</html>