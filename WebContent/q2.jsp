...
<input type="hidden" name="page" value="q3">
The kitchen of the cell is called<br><br>
<input type="radio" name="A" value="1">Cell wall<br>
<input type="radio" name="B" value="1">Nucleus<br>
<input type="radio" name="C" value="1">Vacuoles<br>
<input type="radio" name="D" value="1">Plastids<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q1"><button>BACK</button></a><br><br>
</body>
</html>