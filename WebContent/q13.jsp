...
<input type="hidden" name="page" value="q14">
The salaries A, B, C are in the ratio 2 : 3 : 5.If the increments of 15%, 10% and 20% are allowed respectively in their salaries,
<br> then what will be new ratio of their salaries?<br><br>
<input type="radio" name="A" value="1">3 : 3 : 10<br>
<input type="radio" name="B" value="1">10 : 11 : 20<br>
<input type="radio" name="C" value="1">23 : 33 : 60<br>
<input type="radio" name="D" value="1">Cannot Be Determined<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q12"><button>BACK</button></a><br><br>
</body>
</html>