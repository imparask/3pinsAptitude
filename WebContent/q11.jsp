...
<input type="hidden" name="page" value="q12">
The control unit of cell is<br><br>
<input type="radio" name="A" value="1">Nucleus<br>
<input type="radio" name="B" value="1">Cell wall<br>
<input type="radio" name="C" value="1">Cytoplasm<br>
<input type="radio" name="D" value="1">All Of The Above<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q10"><button>BACK</button></a><br><br>
</body>
</html>