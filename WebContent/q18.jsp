...
<input type="hidden" name="page" value="q19">
The Netaji Subhas National Institute of Sports is located at<br><br>
<input type="radio" name="A" value="1">Bangalore<br>
<input type="radio" name="B" value="1">Kolkata<br>
<input type="radio" name="C" value="1">Darjeeling<br>
<input type="radio" name="D" value="1">Patiala<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q17"><button>BACK</button></a><br><br>
</body>
</html>