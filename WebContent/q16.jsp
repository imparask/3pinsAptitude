...
<input type="hidden" name="page" value="q17">
A and B entered into partnership with capitals in the ratio 4 : 5. After 3 months A withdrew  of his capital and B withdrew  of his capital.<br> 
The gain at the end of 10 months was Rs. 760. A's share in this profit is:<br><br>
<input type="radio" name="A" value="1">Rs.330<br>
<input type="radio" name="B" value="1">Rs.360<br>
<input type="radio" name="C" value="1">Rs.380<br>
<input type="radio" name="D" value="1">Rs.430<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q15"><button>BACK</button></a><br><br>
</body>
</html>