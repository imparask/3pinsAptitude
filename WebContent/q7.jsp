...
<input type="hidden" name="page" value="q8">
If a - b = 3 and a2 + b2 = 29, find the value of ab.<br><br>
<input type="radio" name="A" value="1">10<br>
<input type="radio" name="B" value="1">12<br>
<input type="radio" name="C" value="1">15<br>
<input type="radio" name="D" value="1">18<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q6"><button>BACK</button></a><br><br>
</body>
</html>