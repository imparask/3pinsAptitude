...
The product of two numbers is 120 and the sum of their squares is 289. The sum of the number is:<br><br>
<input type="radio" name="A" value="1">20<br>
<input type="radio" name="B" value="1">23<br>
<input type="radio" name="C" value="1">169<br>
<input type="radio" name="D" value="1">Non Of These<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q9"><button>BACK</button></a><br><br>
</body>
</html>