...
<br>
<br>
<h2> CHOOSE FIELD </h2><br><br>
<h3><a href="<%=request.getContextPath() %>/Controller?page=s&id=s">1.SCIENCE</a></h3><br>
<h3><a href="<%=request.getContextPath() %>/Controller?page=a&id=a">2.ARTS</a></h3><br>
<h3><a href="<%=request.getContextPath() %>/Controller?page=c&id=c">3.COMMERCE</a></h3><br>

<h3><a href="<%=request.getContextPath() %>/Controller?page=at&id=at">CONFUSED ABOUT YOUR FIELD... ?? CLICK HERE</a></h3>
<br><br>
</body>
</html>