...
<input type="hidden" name="page" value="q16">
The five permanent members of the Security Council are<br><br>
<input type="radio" name="A" value="1">China, France, Russia, UK, USA<br>
<input type="radio" name="B" value="1">China, UK, Belgium, France, USA<br>
<input type="radio" name="C" value="1">India, UK, USA, China, Germany<br>
<input type="radio" name="D" value="1">Non Of The Above<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q14"><button>BACK</button></a><br><br>
</body>
</html>