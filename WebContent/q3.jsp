...
<input type="hidden" name="page" value="q4">
Which Indian satellite had a main function to perform X-ray experiments in space and send back data to earth?<br><br>
<input type="radio" name="A" value="1">Aryabhatta<br>
<input type="radio" name="B" value="1">Bhaskara II<br>
<input type="radio" name="C" value="1">Bhaskara IL<br>
<input type="radio" name="D" value="1">Non Of The Above<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q2"><button>BACK</button></a><br><br>
</body>
</html>