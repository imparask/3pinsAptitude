...
<input type="hidden" name="page" value="q7">
Wood is the main raw material for the manufacture of ?<br><br>
<input type="radio" name="A" value="1">Paint<br>
<input type="radio" name="B" value="1">Paper<br>
<input type="radio" name="C" value="1">Ink<br>
<input type="radio" name="D" value="1">Gun Powder<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q5"><button>BACK</button></a><br><br>
</body>
</html>