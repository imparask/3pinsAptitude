...
<input type="hidden" name="page" value="q13">
With which sport is the Jules Rimet trophy associated ?<br><br>
<input type="radio" name="A" value="1">Basketball<br>
<input type="radio" name="B" value="1">Football<br>
<input type="radio" name="C" value="1">Hockey<br>
<input type="radio" name="D" value="1">Golf<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q11"><button>BACK</button></a><br><br>
</body>
</html>