...
<input type="hidden" name="page" value="q6">
Cell was discovered by :<br><br>
<input type="radio" name="A" value="1">Robert Brown<br>
<input type="radio" name="B" value="1">Robert Hooke<br>
<input type="radio" name="C" value="1">John Mendal<br>
<input type="radio" name="D" value="1">Charse Darwin<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q4"><button>BACK</button></a><br><br>
</body>
</html>