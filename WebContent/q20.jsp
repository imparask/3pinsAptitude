...
The power house of cell is called<br><br>
<input type="radio" name="A" value="1">Cell wall<br>
<input type="radio" name="B" value="1">Mitochondria<br>
<input type="radio" name="C" value="1">Ribosomes<br>
<input type="radio" name="D" value="1">Nucleus<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q19"><button>BACK</button></a><br><br>
</body>
</html>