...
<body>
<br>
<h1>CONGRATS..YOU SCORED  <c:out value="${count}"/></h1>
<h2>YOU CAN OPT FOR <c:out value="${msg }"/></h2>
<c:set var="x" value="1"></c:set>
<table>
<tr height="10">
 <th colspan="120" align="center">QUESTION</th>
 <th></th>
 <th colspan="120" align="center">YOUR ANSWERS</th>
</tr>
<c:forEach var="answer" items="${list }">
		<tr height="10" >
		<td colspan="120" align="center"><c:out value="${x}"/></td>
		<td></td>
		<td colspan="120" align="center"><c:out value="${answer}"/></td>
		</tr>
...
<tr height="10">
 <th colspan="120" align="center">QUESTION</th>
 <th></th>
 <th colspan="120" align="center">ANSWERS</th>
</tr>
<c:forEach var="right" items="${result }">
	<tr height="10">
		<td colspan="120" align="center"><c:out value="${x}"/></td>
		<td></td>
		<td colspan="120" align="center"><c:out value="${right}"/></td>
	</tr>
	<c:set var="x" value="${x+1}"></c:set>
</c:forEach>
</table>
