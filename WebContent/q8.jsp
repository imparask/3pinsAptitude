...
The cells capable of changing shapes are<br><br>
<input type="radio" name="A" value="1">Amoeba cell<br>
<input type="radio" name="B" value="1">WBC(WHITE BLOOD CELLS)<br>
<input type="radio" name="C" value="1">Both Of The Above<br>
<input type="radio" name="D" value="1">Non Of The Above<br>
<hr>
<input type="submit" value="NEXT">
</form>
<br>
<a href="<%=request.getContextPath() %>/Controller?page=q7"><button>BACK</button></a><br><br>
</body>
</html>